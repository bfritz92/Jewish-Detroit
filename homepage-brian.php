...
?>
	...
	<section id="front-page-splash" class="content-area front-page-splash">
		<!--ACF  HEADLINE -->
		<h1 class="white front-page-splash--headline baskerville "><?php the_field('headline'); ?></h1>
		<!-- ACF BYLINE -->
		<p class="white front-page-splash--byline "><?php the_field('byline'); ?></p>
	...
	<section id="front-page-intro" class="front-page-intro">
		...
		<figure class="front-page-intro--panel-1">
			<div class="front-page-intro--panel-1--text ">
		...
		<figure class="front-page-intro--panel-2">
			...
			<div class="front-page-intro--panel-2--text ">
...
<a href="https://2019.jewishdetroit.org/events-front"><h3 class="events-page--load-more blue">See More Events <i class="fas fa-angle-double-right"></i></h3></a>
 ...
 <section id="donation-panel" class="donation-panel">
	<div class="donation-panel--wrapper">
		<div class="donation-panel--wrapper-copy ">
			<!-- ACF donation-title -->
		...
		<div class="donation-panel--buttons-example ">

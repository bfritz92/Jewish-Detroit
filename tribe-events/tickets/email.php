									...
									<td valign="top" class="ticket-content" align="left" width="580" border="0" cellpadding="20" cellspacing="0" style="padding:20px; background:#f7f7f7;">
										...
										if ( ! empty( $header_img ) ) {
											...
											<table border="0" cellpadding="0" cellspacing="0" width="100%">
												<tr>
													<td class="ticket-image" valign="top" align="center" width="100%" style="padding-bottom:15px !important;">
										...
										<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
											<tr>
												<td valign="top" align="center" width="100%" style="padding: 0 !important; margin:0 !important;">
													<h2 style="color:#0a0a0e; margin:0 0 10px 0 !important; font-family: 'Helvetica Neue', Helvetica, sans-serif; font-style:normal; font-weight:700; font-size:28px; letter-spacing:normal; text-align:center;line-height: 100%;">											
														<?php echo $event->post_title; ?>														
													</h2>
													<?php $ticket_id = $ticket['ticket_id'];?>
													<p><?php echo get_the_excerpt($ticket_id); ?></p>
												</td>
											</tr>
										</table>
										...
										<table class="ticket-details" border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
											<tr>
												<td class="ticket-details" valign="top" align="left" width="133" style="padding: 0; width:100px; margin:0 !important;">
												...
												<td class="ticket-details" valign="top" align="left" width="153" style="padding: 0 !important; width:120px; margin:0 !important;">
												...
												<td class="ticket-details new-row new-left-row" valign="top" align="left" width="133" style="padding: 0; width:120px; margin:0 !important;">

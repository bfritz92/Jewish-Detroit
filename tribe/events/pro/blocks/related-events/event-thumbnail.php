 ...
 * [your-theme]/tribe/pro/blocks/related-events/event-thumbnail.php
 *
...
<div class="tribe-related-events-thumbnail">
	<a href="<?php echo esc_url( tribe_get_event_link( $event ) ); ?>" class="url" rel="bookmark" tabindex="-1"><?php echo $thumb ?>This is B.S.</a>
</div>